...
# Form implementation generated from reading ui file 'formAmazonSkuKeywordRelation.ui'
#
...
class Ui_AmazonSkuKeywordRelationForm(object):
    def setupUi(self, AmazonSkuKeywordRelationForm):
        AmazonSkuKeywordRelationForm.setObjectName("AmazonSkuKeywordRelationForm")
        AmazonSkuKeywordRelationForm.resize(906, 655)
        self.vlAmazonSkuKeywordRelationForm = QtWidgets.QVBoxLayout(AmazonSkuKeywordRelationForm)
        ...
        self.keywordToolBar = QtWidgets.QWidget(AmazonSkuKeywordRelationForm)
        ...
        self.twAmazonSKuKeywordRelation = QtWidgets.QTableWidget(AmazonSkuKeywordRelationForm)
        self.twAmazonSKuKeywordRelation.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.twAmazonSKuKeywordRelation.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.twAmazonSKuKeywordRelation.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.twAmazonSKuKeywordRelation.setObjectName("twAmazonSKuKeywordRelation")
        self.twAmazonSKuKeywordRelation.setColumnCount(3)
        self.twAmazonSKuKeywordRelation.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.twAmazonSKuKeywordRelation.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.twAmazonSKuKeywordRelation.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.twAmazonSKuKeywordRelation.setHorizontalHeaderItem(2, item)
        self.twAmazonSKuKeywordRelation.horizontalHeader().setHighlightSections(False)
        self.vlAmazonSkuKeywordRelationForm.addWidget(self.twAmazonSKuKeywordRelation)
        self.vlAmazonSkuKeywordRelationForm.setStretch(1, 1)

        self.retranslateUi(AmazonSkuKeywordRelationForm)
        QtCore.QMetaObject.connectSlotsByName(AmazonSkuKeywordRelationForm)

    def retranslateUi(self, AmazonSkuKeywordRelationForm):
        _translate = QtCore.QCoreApplication.translate
        AmazonSkuKeywordRelationForm.setWindowTitle(_translate("AmazonSkuKeywordRelationForm", "Amazon SKU Keyword Relation"))
        self.lbPagerInfo.setText(_translate("AmazonSkuKeywordRelationForm", "R:{1}"))
        self.twAmazonSKuKeywordRelation.setSortingEnabled(True)
        item = self.twAmazonSKuKeywordRelation.horizontalHeaderItem(0)
        item.setText(_translate("AmazonSkuKeywordRelationForm", "#"))
        item = self.twAmazonSKuKeywordRelation.horizontalHeaderItem(1)
        item.setText(_translate("AmazonSkuKeywordRelationForm", "SKU"))
        item = self.twAmazonSKuKeywordRelation.horizontalHeaderItem(2)
        item.setText(_translate("AmazonSkuKeywordRelationForm", "Title"))
