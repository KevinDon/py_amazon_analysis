...
# Form implementation generated from reading ui file 'formNewaimCategory.ui'
#
...
class Ui_NewaimCategoryForm(object):
    def setupUi(self, NewaimCategoryForm):
        NewaimCategoryForm.setObjectName("NewaimCategoryForm")
        NewaimCategoryForm.resize(906, 655)
        self.vlCategoryForm = QtWidgets.QVBoxLayout(NewaimCategoryForm)
        ...
        self.productToolBar = QtWidgets.QWidget(NewaimCategoryForm)
        ...
        self.twNewaimProductCategoryList = QtWidgets.QTableWidget(NewaimCategoryForm)
        self.twNewaimProductCategoryList.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.twNewaimProductCategoryList.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.twNewaimProductCategoryList.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.twNewaimProductCategoryList.setObjectName("twNewaimProductCategoryList")
        self.twNewaimProductCategoryList.setColumnCount(7)
        self.twNewaimProductCategoryList.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.twNewaimProductCategoryList.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.twNewaimProductCategoryList.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.twNewaimProductCategoryList.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.twNewaimProductCategoryList.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.twNewaimProductCategoryList.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.twNewaimProductCategoryList.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        self.twNewaimProductCategoryList.setHorizontalHeaderItem(6, item)
        self.twNewaimProductCategoryList.horizontalHeader().setHighlightSections(False)
        self.vlCategoryForm.addWidget(self.twNewaimProductCategoryList)
        self.vlCategoryForm.setStretch(1, 1)

        self.retranslateUi(NewaimCategoryForm)
        QtCore.QMetaObject.connectSlotsByName(NewaimCategoryForm)

    def retranslateUi(self, NewaimCategoryForm):
        _translate = QtCore.QCoreApplication.translate
        NewaimCategoryForm.setWindowTitle(_translate("NewaimCategoryForm", "Newaim Category List"))
        self.pushButton.setText(_translate("NewaimCategoryForm", "导入SKU与Category关系"))
        self.tbActionLog.setText(_translate("NewaimCategoryForm", "..."))
        self.lbPagerInfo.setText(_translate("NewaimCategoryForm", "R:{1}"))
        self.twNewaimProductCategoryList.setSortingEnabled(True)
        item = self.twNewaimProductCategoryList.horizontalHeaderItem(0)
        item.setText(_translate("NewaimCategoryForm", "#"))
        item = self.twNewaimProductCategoryList.horizontalHeaderItem(1)
        item.setText(_translate("NewaimCategoryForm", "Title"))
        item = self.twNewaimProductCategoryList.horizontalHeaderItem(2)
        item.setText(_translate("NewaimCategoryForm", "Code"))
        item = self.twNewaimProductCategoryList.horizontalHeaderItem(3)
        item.setText(_translate("NewaimCategoryForm", "Updated At"))
        item = self.twNewaimProductCategoryList.horizontalHeaderItem(4)
        item.setText(_translate("NewaimCategoryForm", "Created At"))
        item = self.twNewaimProductCategoryList.horizontalHeaderItem(5)
        item.setText(_translate("NewaimCategoryForm", "Level"))
        item = self.twNewaimProductCategoryList.horizontalHeaderItem(6)
        item.setText(_translate("NewaimCategoryForm", "Parent Id"))
