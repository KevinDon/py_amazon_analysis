...
class Ui_ProductForm(object):
    def setupUi(self, ProductForm):
        ...
        ProductForm.resize(906, 655)
        self.vlProductForm = QtWidgets.QVBoxLayout(ProductForm)
        self.vlProductForm.setContentsMargins(2, 6, 2, 2)
        self.vlProductForm.setSpacing(3)
        self.vlProductForm.setObjectName("vlProductForm")
        self.productToolBar = QtWidgets.QWidget(ProductForm)
        ...
        self.vlProductForm.addWidget(self.productToolBar)
        self.twProductList = QtWidgets.QTableWidget(ProductForm)
        self.twProductList.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.twProductList.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.twProductList.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.twProductList.setObjectName("twProductList")
        self.twProductList.setColumnCount(6)
        self.twProductList.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.twProductList.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.twProductList.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.twProductList.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.twProductList.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.twProductList.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.twProductList.setHorizontalHeaderItem(5, item)
        self.twProductList.horizontalHeader().setHighlightSections(False)
        self.vlProductForm.addWidget(self.twProductList)
        self.vlProductForm.setStretch(1, 1)
    ...
    def retranslateUi(self, ProductForm):
        ...
        ProductForm.setWindowTitle(_translate("ProductForm", "Product List"))
        self.lbPagerInfo.setText(_translate("ProductForm", "R:{1}"))
        self.twProductList.setSortingEnabled(True)
        item = self.twProductList.horizontalHeaderItem(0)
        item.setText(_translate("ProductForm", "#"))
        item = self.twProductList.horizontalHeaderItem(1)
        item.setText(_translate("ProductForm", "SKU"))
        item = self.twProductList.horizontalHeaderItem(2)
        item.setText(_translate("ProductForm", "ASIN"))
        item = self.twProductList.horizontalHeaderItem(3)
        item.setText(_translate("ProductForm", "Combine Type"))
        item = self.twProductList.horizontalHeaderItem(4)
        item.setText(_translate("ProductForm", "Updated At"))
        item = self.twProductList.horizontalHeaderItem(5)
        item.setText(_translate("ProductForm", "Created At"))
