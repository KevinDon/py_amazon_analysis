  ...
  <el-container>
    ...
    >
      ...
      <side-filter
        ...
        isCategory=true
        isKeyword=true
        getSkuUrl="/v1/statmazoncategorylist/"
        getCategoryUrl=""
...
<script>
  ...
  export default {
    name: "chartBestSellerReportChart",
    components: {
      ...
      filterSubmitHandle: async function (form) {
        ...
        if (form.chartSelected.length > 0) {
          ...
          if (vm.showDailyChart) {
            ...
            await ChartsApi.statamazonskutotalitemsday('/v1/statamazonskubestsellerrankday/',{}, queryParams).then(response => {
          ...
          if (vm.showMonthlyChart) {
            ...
            await ChartsApi.statamazonskutotalitemsmonth('/v1/statamazonskubestsellerrankmonth/',{}, queryParams).then(response => {
          ...
          if (vm.showWeeklyChart) {
            ...
            queryParams.push([{'first_day-gte-and': _beginDate}]);
            queryParams.push([{'last_day-lte-and': _endDate}]);
            await ChartsApi.statamazonskutotalitemsweek('/v1/statamazonskubestsellerrankweek/',{}, queryParams).then(response => {
