      ...
      filterSubmitHandle: async function (form) {
        ...
        if (form.chartSelected.length > 0) {
          ...
          if (vm.showDailyChart) {
            ...
            await ChartsApi.fetchstatamazonlinedaily('/v1/statamazonlineuvday/', {
              order: ['dy','line_id'],
              size: 500000
          ...
          if (vm.showMonthlyChart) {
            ...
            await ChartsApi.fetchstatamazonlinemonthly('/v1/statamazonlineuvmonth/', {
              order: ['yr','mo','line_id'],
              size: 500000
            }, queryParams).then(response => {
          ...
          if (vm.showWeeklyChart) {
            ...
            queryParams.push([{'first_day-gte-and': _beginDate}]);
            queryParams.push([{'last_day-lte-and': _endDate}]);
            await ChartsApi.fetchstatamazonlineweekly('/v1/statamazonlineuvweek/', {
              order: ['yr','wk','line_id'],
              size: 500000
            }, queryParams).then(response => {
