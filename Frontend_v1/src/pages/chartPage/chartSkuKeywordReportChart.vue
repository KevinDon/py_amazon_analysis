  ...
  <el-container>
    ...
    >
      ...
      <side-filter
        ...
        getKeywordUrl="/v1/statamazonkeywordsset/"
        getCategoryUrl="/v1/statmazoncategorys/"
...
<script>
  ...
  export default {
    name: "chartSkuKeywordReportChart",
    components: {
    ...
    methods: {
      ...
      filterSubmitHandle: async function (form) {
        ...
        if (form.skuSelected.length > 0) {
          ...
          form.keywordSelected.forEach(item => {
            if (item != undefined) {
              _filter2.push({'sku_keyword_id-eq': item.id})
            }
          });
          form.categorySelected.forEach(item => {
            if (item != undefined) {
              _filter3.push({'category_id-eq': item.id})
            }
          });
        ...
        if (form.chartSelected.length > 0) {
          ...
          if (vm.showDailyChart) {
            ...
            queryParams.push(_filter2);
            queryParams.push(_filter3);
            queryParams.push([{'dy-gte-and': _beginDate}]);
            queryParams.push([{'dy-lte-and': _endDate}]);
            await ChartsApi.statamazonskutotalitemsday('/v1/statamazonskukeywordrankday/',{}, queryParams).then(response => {
          ...
          if (vm.showMonthlyChart) {
            ...
            await ChartsApi.statamazonskutotalitemsmonth('/v1/statamazonskukeywordrankmonth/',{}, queryParams).then(response => {
          ...
          if (vm.showWeeklyChart) {
            ...
            queryParams.push([{'first_day-gte-and': _beginDate}]);
            queryParams.push([{'last_day-lte-and': _endDate}]);
            await ChartsApi.statamazonskutotalitemsweek('/v1/statamazonskukeywordrankweek/',{}, queryParams).then(response => {
