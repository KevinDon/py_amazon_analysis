      ...
      filterSubmitHandle: async function (form) {
        ...
        if (form.chartSelected.length > 0) {
          ...
          if (vm.showDailyChart) {
            ...
            await ChartsApi.statamazonskutotalitemsday('/v1/statamazonskureviewrankday/',{}, queryParams).then(response => {
          ...
          if (vm.showMonthlyChart) {
            ...
            await ChartsApi.statamazonskutotalitemsmonth('/v1/statamazonskureviewrankmonth/',{}, queryParams).then(response => {
          ...
          if (vm.showWeeklyChart) {
            ...
            queryParams.push([{'first_day-gte-and': _beginDate}]);
            queryParams.push([{'last_day-lte-and': _endDate}]);
            await ChartsApi.statamazonskutotalitemsweek('/v1/statamazonskureviewrankweek/',{}, queryParams).then(response => {
