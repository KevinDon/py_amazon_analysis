  ...
  <el-container>
    ...
    >
      ...
      <side-filter
        ...
        v-loading.fullscreen.lock="fullscreenLoading"></side-filter>
    </el-aside>
    <el-container>
      ...
      filterSubmitHandle: async function (form) {
        ...
        if (form.chartSelected.length > 0) {
          ...
          if (vm.showDailyChart) {
            ...
            await ChartsApi.statamazonskutotalitemsday('/v1/statamazonskutotalitemsday/', {}, queryParams).then(response => {
          ...
          if (vm.showMonthlyChart) {
            ...
            await ChartsApi.statamazonskutotalitemsmonth('/v1/statamazonskutotalitemsmonth/', {}, queryParams).then(response => {
          ...
          if (vm.showWeeklyChart) {
            ...
            queryParams.push([{'first_day-gte-and': _beginDate}]);
            queryParams.push([{'last_day-lte-and': _endDate}]);
            await ChartsApi.statamazonskutotalitemsweek('/v1/statamazonskutotalitemsweek/', {}, queryParams).then(response => {
