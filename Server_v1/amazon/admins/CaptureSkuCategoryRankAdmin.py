...
from amazon.model import CaptureSkuCategoryRankModel
from django.utils.translation import ugettext as _
from manager.admin import CommonAdmin


@admin.register(CaptureSkuCategoryRankModel)
class CaptureSkuCategoryRankAdmin(CommonAdmin):
    ...
    def change_view(self, request, object_id, extra_context=None):
        ...
        return super(CaptureSkuCategoryRankAdmin, self).change_view(request, object_id, extra_context=extra_context)