...
'''按关键词统计的每月视图数据'''
class StatAmazonSkuKeywordRankMonthDv(models.Model):
    asin = models.CharField(max_length=100, verbose_name=_('Asin'))
    sku = models.CharField(max_length=100, verbose_name=_('Sku'))
    sku_keyword_id = models.IntegerField(verbose_name=_('Keyword Id'))
    category_id = models.IntegerField(verbose_name=_('Category Id'))
...
'''按关键词统计的每周视图数据'''
class StatAmazonSkuKeywordRankWeekDv(models.Model):
    asin = models.CharField(max_length=100, verbose_name=_('Asin'))
    sku = models.CharField(max_length=100, verbose_name=_('Sku'))
    sku_keyword_id = models.IntegerField(verbose_name=_('Keyword Id'))
    category_id = models.IntegerField(verbose_name=_('Category Id'))
