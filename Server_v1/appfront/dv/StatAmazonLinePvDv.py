...
'''按Line统计的每天视图数据'''
class StatAmazonLinePvDayDv(models.Model):
    ...
    class Meta:
        ...
        ordering = ['line_id']
        verbose_name_plural = _('Line P/V for days')


'''按Line统计的每月视图数据'''
class StatAmazonLinePvMonthDv(models.Model):
    line_id = models.IntegerField(verbose_name= _('Line_ID'), null=True)
    title = models.CharField(max_length=100, verbose_name=_('Title'))
...
'''按Line统计的每周视图数据'''
class StatAmazonLinePvWeekDv(models.Model):
    line_id = models.IntegerField(verbose_name= _('Line_ID'), null=True)
    title = models.CharField(max_length=100, verbose_name=_('Title'))
    yr = models.IntegerField(verbose_name=_('Year'), null=True)
    ...
    class Meta:
        ...
        ordering = ['line_id']
        verbose_name_plural = _('Line P/V for weeks')
