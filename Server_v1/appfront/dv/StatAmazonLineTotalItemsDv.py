...
'''按Line统计的每天视图数据'''
class StatAmazonLineTotalItemsDayDv(models.Model):
    ...
    class Meta:
        ...
        ordering = ['line_id']
        verbose_name_plural = _('Line Total Items for days')


'''按Line统计的每月视图数据'''
class StatAmazonLineTotalItemsMonthDv(models.Model):
    line_id = models.IntegerField(verbose_name= _('Line_ID'), null=True)
    title = models.CharField(max_length=100, verbose_name=_('Title'))
    ...
    class Meta:
        ...
        ordering = ['line_id']
        verbose_name_plural = _('Line Total Items for months')


'''按Line统计的每周视图数据'''
class StatAmazonLineTotalItemsWeekDv(models.Model):
    line_id = models.IntegerField(verbose_name= _('Line_ID'), null=True)
    title = models.CharField(max_length=100, verbose_name=_('Title'))
    yr = models.IntegerField(verbose_name=_('Year'), null=True)
    ...
    class Meta:
        ...
        ordering = ['line_id']
        verbose_name_plural = _('Line Total Items for weeks')
