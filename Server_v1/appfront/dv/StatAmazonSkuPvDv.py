...
'''按SKU统计的每天视图数据'''
class StatAmazonSkuPvDayDv(models.Model):
    ...
    class Meta:
        ...
        ordering = ['sku']
        verbose_name_plural = _('SKU P/V for days')


'''按SKU统计的每月视图数据'''
class StatAmazonSkuPvMonthDv(models.Model):
    sku = models.CharField(max_length=100, verbose_name= _('SKU'))
    asin = models.CharField(max_length=20, verbose_name= _('Asin'))
...
'''按SKU统计的每周视图数据'''
class StatAmazonSkuPvWeekDv(models.Model):
    sku = models.CharField(max_length=100, verbose_name= _('SKU'))
    asin = models.CharField(max_length=20, verbose_name= _('Asin'))
    yr = models.IntegerField(verbose_name=_('Year'), null=True)
    ...
    class Meta:
        ...
        ordering = ['sku']
        verbose_name_plural = _('SKU P/V for weeks')
