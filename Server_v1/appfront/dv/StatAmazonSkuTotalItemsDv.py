...
'''按SKU统计的每天视图数据'''
class StatAmazonSkuTotalItemsDayDv(models.Model):
    ...
    class Meta:
        ...
        ordering = ['sku']
        verbose_name_plural = _('SKU Total Items for days')


'''按SKU统计的每月视图数据'''
class StatAmazonSkuTotalItemsMonthDv(models.Model):
    sku = models.CharField(max_length=100, verbose_name= _('SKU'))
    asin = models.CharField(max_length=20, verbose_name= _('Asin'))
    ...
    class Meta:
        ...
        ordering = ['sku']
        verbose_name_plural = _('SKU Total Items for months')


'''按SKU统计的每周视图数据'''
class StatAmazonSkuTotalItemsWeekDv(models.Model):
    sku = models.CharField(max_length=100, verbose_name= _('SKU'))
    asin = models.CharField(max_length=20, verbose_name= _('Asin'))
    yr = models.IntegerField(verbose_name=_('Year'), null=True)
    ...
    class Meta:
        ...
        ordering = ['sku']
        verbose_name_plural = _('SKU Total Items for weeks')
