...
-- DROP MATERIALIZED VIEW IF EXISTS view_i_amazon_sku_pv_day;
CREATE MATERIALIZED VIEW IF NOT EXISTS "public"."view_i_amazon_sku_pv_day" AS
	SELECT
...
-- DROP MATERIALIZED VIEW IF EXISTS view_i_amazon_sku_pv_month;
CREATE MATERIALIZED VIEW IF NOT EXISTS "public"."view_i_amazon_sku_pv_month" AS
	SELECT
		row_number() OVER () AS id
		, main.sku
		, main.asin
...
-- DROP MATERIALIZED VIEW IF EXISTS view_i_amazon_sku_pv_week;
CREATE MATERIALIZED VIEW IF NOT EXISTS "public"."view_i_amazon_sku_pv_week" AS
